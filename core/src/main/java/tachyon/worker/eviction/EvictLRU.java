...
public final class EvictLRU extends EvictLRUBase {
  ...
  public synchronized Pair<StorageDir, List<BlockInfo>> getDirCandidate(long userId, StorageDir[] storageDirs,
    ...
    HashMap<StorageDir, HashMap<Long, HashSet<Long>>> dir2BlocksToEvict =
      new HashMap<StorageDir, HashMap<Long, HashSet<Long>>>();
    ...
    while (true) {
      ...
      Pair<StorageDir, Long> candidate =
          getLRUBlockCandidate(userId, storageDirs, dir2LRUBlocks, dir2BlocksToEvict, pinList);
   ...
   */
  private Pair<StorageDir, Long> getLRUBlockCandidate(Long userId, StorageDir[] storageDirs,
      Map<StorageDir, Pair<Long, Long>> dir2LRUBlocks,
      HashMap<StorageDir, HashMap<Long, HashSet<Long>>> dir2BlocksToEvict, Set<Integer> pinList) {
    ...
    for (StorageDir dir : storageDirs) {
      ...
      if (!dir2LRUBlocks.containsKey(dir)) {
        HashMap<Long, HashSet<Long>> blocksToEvict = dir2BlocksToEvict.get(dir);
        lruBlock = getLRUBlockUser(userId, dir, blocksToEvict, pinList);
